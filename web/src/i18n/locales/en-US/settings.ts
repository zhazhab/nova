const settings = {
  ...
  'settings.access.restartHint': 'After enabling this and restarting Nova, Nova listens on the LAN address. Other devices on the same local network can open Nova with the startup access URL and sign in on the page with this username and password. Localhost access does not require login.',
  ...
  'settings.updates.applyingRestart': 'Nova is restarting and applying the update.',
  ...
  'settings.updates.stagedRestart': 'Update staged. Restart and install to exit Nova, replace files, and launch the new version automatically.',
