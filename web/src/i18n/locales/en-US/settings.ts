const settings = {
  ...
  'settings.access.restartHint': 'After enabling this and restarting Nova, the frontend listens on the LAN address. Other devices on the same local network should open Nova with the frontend URL above and sign in on the page with this username and password. Localhost access does not require login.',
